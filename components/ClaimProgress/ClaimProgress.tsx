...
export default function ClaimProgress({
  ...
  return (
    <div className="mt-4 flex flex-col items-center gap-6">
      {/* Overview */}
      <div className="flex w-full flex-col items-stretch rounded-xl border border-white/20 bg-white/5 p-8 pb-12 lg:max-w-3xl">
        {/* Wallet Entry */}
        <WalletEntry
          airdrop={airdrop}
          network={network}
        ...
        {/* Data */}
        <div className="mt-6 gap-1.5">
          <div className="flex justify-between">
            {/* Claimable on */}
            <div>
              <span className="text-base font-medium text-white/60">
                Claimable on <span className="text-[#6FFFCB]">Sept. 11th</span>
              </span>
            ...
            <div className="flex flex-col items-end">
              <span className="text-right text-base font-medium text-white/60">
                Total allocation
              </span>
          ...
          <div className="relative mt-2.5 h-2 w-full rounded-full bg-white/15">
            <div
              className="absolute h-2 min-w-2 rounded-full opacity-40"
              style={{
            ...
            <div
              className="absolute left-0 top-0 h-2 min-w-2 rounded-full"
              style={{
          ...
          <div className="mt-2.5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <div className="h-2.5 w-2.5 rounded-full bg-white/15 opacity-40"></div>
              Locked
              <span className="">
                {formatBalanceNumber(total - unlocked, 0)}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="mt-4 flex flex-col items-center gap-3">
        <div className="flex w-full flex-col items-center gap-7 rounded-xl border border-white/20 p-6 lg:w-[1125px]">
          <span className="flex flex-col items-center gap-1.5 text-center text-base font-medium lg:flex-row lg:text-left">
            Vesting Rules:
          ...
          <div className="flex w-[50vw] flex-col items-center justify-between gap-2 px-10 pr-2 lg:w-full lg:flex-row">
            {progressList.map((progress) => (
              <div
                className="flex w-full flex-row items-center justify-between gap-2 lg:w-auto lg:flex-col"
                key={progress.label}
              >
                <span className="">{progress.label}</span>
                <span className="text-right text-[#6FFFCB]">
                  {progress.value}
                </span>
              </div>
            ))}
          </div>
          <div className="flex flex-col items-center justify-center gap-4 text-sm font-medium text-white/80 lg:flex-row">
      ...
      <button
        ...
        className="btn btn-sm rounded-full border-white/60 bg-transparent text-white/60 hover:border-[#6FFFCB] hover:bg-transparent hover:text-[#6FFFCB]"
      >
...
const HoloToken = () => {
  return (
    <div
      className="flex items-center gap-0.5 rounded-[3px] px-1.5 py-1 text-xs text-black"
      style={{
